# Блок-схема программы с циклом WHILE
...
flowchart TD
    ...
    InitX --> WhileCondition{x ≤ B?}
    
    WhileCondition -->|Нет| End2([Конец])
    WhileCondition -->|Да| OutputX[Вывод x]
    ...
    IncrementX[x = x + DEL] --> WhileCondition
```
